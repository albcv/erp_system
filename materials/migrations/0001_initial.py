    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(choices=[('unit', 'Unit'), ('kg', 'Kilogram'), ('m', 'Meter'), ('piece', 'Piece')], max_length=20, verbose_name='Unit measure')),
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('name', 'material_type'), name='unique_name_per_type')],
            },
        ),
    ]
